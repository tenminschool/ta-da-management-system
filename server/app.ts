...
function normaliseDraft(raw: unknown): RequestDraft {
  ...
  return {
    ...
    accommodationType: d.accommodationType === "hotel" || d.accommodationType === "personal" ? d.accommodationType : "",
    ...
    advanceType: d.advanceType === "full" || d.advanceType === "partial" ? d.advanceType : "",
