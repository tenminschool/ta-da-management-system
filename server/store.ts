...
export function toRequest(r: Row & { _row: string }): RequestRecord & { _row: string } {
  return {
    ...
    accommodationType: r.accommodation_type === "hotel" || r.accommodation_type === "personal" ? r.accommodation_type : "",
    ...
    advanceType: r.advance_type === "full" || r.advance_type === "partial" ? r.advance_type : "",
