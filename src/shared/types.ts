...
export const STATUS_GROUPS = {
  pending: {
    label: 'Pending',
    statuses: ['manager_review', 'admin_review', 'finance_review'],
  },
  approved: {
    label: 'Approved',
    statuses: ['payment_processing', 'paid', 'payment_disputed', 'completed'],
  },
  rejected: { label: 'Rejected', statuses: ['rejected'] },
  returned: { label: 'Returned', statuses: ['returned'] },
  paymentPending: {
    label: 'Payment Pending',
    statuses: ['payment_processing', 'payment_disputed'],
  },
  paid: { label: 'Paid', statuses: ['paid', 'completed'] },
} as const satisfies Record<
  string,
  { label: string; statuses: readonly Status[] }
>;
