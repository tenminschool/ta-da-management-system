...
export const TABS: TabSpec[] = [
  // ── People ────────────────────────────────────────────────────────────────
  {
    ...
    color: BLUE,
    widths: [
      230, 110, 170, 240, 100, 90, 70, 150, 180, 130, 210, 130, 150, 90, 150,
    ],
    headers: [
  ...
  // ── One row per request ───────────────────────────────────────────────────
  {
    ...
    color: GREEN,
    widths: [
      150, 150, 150, 150, 110, 160, 210, 70, 140, 160, 100, 130, 110, 110, 80,
      260,
    ],
    headers: [
      'request_id',
      ...
      'trip_direction',
      'company_transport_amount',
      'company_accommodation_amount',
      'company_amounts_by',
      'company_amounts_at',
      'dhaka_office',
      'linked_to',
  ...
  // ── One row per request, one column group per desk ────────────────────────
  {
    ...
    color: AMBER,
    widths: [
      150, 170, 170, 160, 240, 110, 170, 160, 260, 110, 170, 160, 260, 110, 170,
      160, 260, 110, 170, 160, 260,
    ],
    headers: [
      'request_id',
      'employee_name',
      ...
      'advance_hr_by',
      'advance_hr_at',
      'advance_dept_head_status',
      'advance_dept_head_by',
      'advance_dept_head_at',
      'last_action',
      'last_action_at',
    ],
  },
  ...
  // ── Admin-configurable policy ─────────────────────────────────────────────
  {
    ...
    seed: [
      [
        'PER_DIEM_AMOUNT',
        250,
        'Per-Diem amount (BDT) when working hours >= threshold',
        '2026-01-01',
      ],
      [
        'PER_DIEM_MIN_HOURS',
        5,
        'Minimum working hours to qualify for Per-Diem',
        '2026-01-01',
      ],
      [
        'OFFICE_MEAL_DEDUCTION',
        75,
        'Deducted from Per-Diem (BDT) when an office meal was taken',
        '2026-01-01',
      ],
      [
        'SHORT_HOUR_MEAL_ALLOWANCE',
        150,
        'Added to the claim (BDT), per traveller, when working hours are under PER_DIEM_MIN_HOURS and no office meal was taken',
        '2026-01-01',
      ],
      [
        'FUEL_RATE_BIKE',
        3,
        'Reimbursement per KM for a personal bike (BDT/km)',
        '2026-01-01',
      ],
      [
        'FUEL_RATE_CAR',
        10,
        'Reimbursement per KM for a personal car (BDT/km)',
        '2026-01-01',
      ],
      [
        'TEAM_CAR_MIN_MEMBERS',
        3,
        'Minimum team size before Car becomes selectable for team travel',
        '2026-01-01',
      ],
      [
        'RENT_A_CAR_LIMIT',
        6000,
        'Maximum rent-a-car cost (BDT) one way',
        '2026-01-01',
      ],
      [
        'RENT_A_CAR_MIN_HEADCOUNT',
        3,
        'Minimum employees required to book a rent-a-car',
        '2026-01-01',
      ],
      [
        'ADVANCE_MIN_TRIP_DAYS',
        3,
        'Advance is offered only when trip days exceed this',
        '2026-01-01',
      ],
      [
        'ADVANCE_AUTO_LIMIT',
        10000,
        'Advance above this amount also needs Department Head approval',
        '2026-01-01',
      ],
      [
        'ADVANCE_SETTLEMENT_DAYS',
        3,
        'Working days after trip end to settle an advance',
        '2026-01-01',
      ],
      [
        'COMPANY_ARRANGE_NOTICE_DAYS',
        2,
        'Business days of notice required for company-arranged travel',
        '2026-01-01',
      ],
      [
        'REQUIRE_DOCUMENT_LINK',
        'Yes',
        'Require at least one document link when money is claimed',
        '2026-01-01',
      ],
      ...
      [
        'CLAIM_WINDOW_DAYS',
        7,
        'Days after travel within which a claim must be submitted. An administrator can unlock a late one.',
        '2026-01-01',
      ],
      [
        'ALLOW_BANK_PAYOUT',
        'No',
        'Yes to let people be paid into a bank account as well as bKash. No pays everyone by bKash.',
        '2026-01-01',
      ],
      [
        'REQUEST_ID_PREFIX',
        'TA',
        'Prefix used when generating request numbers',
        '2026-01-01',
      ],
    ],
  },
...
export const TAB = Object.fromEntries(TABS.map((t) => [t.title, t])) as Record<
  string,
  TabSpec
>;
